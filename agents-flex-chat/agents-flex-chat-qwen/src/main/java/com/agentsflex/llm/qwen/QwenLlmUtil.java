...
public class QwenLlmUtil {
    ...
    public static String promptToPayload(Prompt prompt, QwenChatConfig config, ChatOptions options) {
        ...
        Maps params = Maps.of("model", Optional.ofNullable(options.getModel()).orElse(config.getModel()))
            ...
            .setIf(options.isStreaming(), "stream_options", Maps.of("include_usage", true))
