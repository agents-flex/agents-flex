...
import com.agentsflex.text2sql.jdbc.dialect.AbstractJdbcDialect;
...
public class OracleJdbcDialect extends AbstractJdbcDialect {
    ...
    @Override
    protected ResultSet forRemarks(String schema, TableInfo table, DatabaseMetaData dbMeta, Connection conn) throws SQLException {
