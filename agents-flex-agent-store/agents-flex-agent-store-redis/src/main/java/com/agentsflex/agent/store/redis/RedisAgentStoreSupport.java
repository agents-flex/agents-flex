...
abstract class RedisAgentStoreSupport {
    ...
    protected String key(String type, String id) {
        return config.keyPrefix() + "{agent-store}:" + type + ":" + id;
    }

    protected String index(String type) {
        return config.keyPrefix() + "{agent-store}:" + type;
    }
    ...
    protected static java.util.List<String> keys(String... values) {
        return java.util.Arrays.asList(values);
    }

    protected static java.util.List<String> args(String... values) {
        return java.util.Arrays.asList(values);
    }

    protected static java.util.List<String> noKeys() {
