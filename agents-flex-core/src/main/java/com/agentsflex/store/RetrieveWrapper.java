...
public class RetrieveWrapper extends VectorData {
    ...
    public RetrieveWrapper eq(String key, Object value) {
        return eq(Connector.AND, key, value);
    }

    public RetrieveWrapper eq(Connector connector, String key, Object value) {
    ...
    public RetrieveWrapper ne(String key, Object value) {
        return ne(Connector.AND, key, value);
    }

    public RetrieveWrapper ne(Connector connector, String key, Object value) {
        if (this.condition == null) {
    ...
    public RetrieveWrapper group(RetrieveWrapper wrapper) {
        return group(wrapper.condition);
    }

    public RetrieveWrapper group(Condition condition) {
        if (this.condition == null) {
    ...
    public RetrieveWrapper group(Consumer<RetrieveWrapper> consumer) {
        RetrieveWrapper newWrapper = new RetrieveWrapper();
