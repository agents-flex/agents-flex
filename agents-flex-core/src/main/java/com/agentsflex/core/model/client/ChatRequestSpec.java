...
/**
 * Chat transport configuration exposed to interceptors.
 * Request body content is deliberately excluded and is built after the interceptor chain completes.
 */
public class ChatRequestSpec {
    ...
    public ChatRequestSpec(String url, Map<String, String> headers, int retryCount, int retryInitialDelayMs) {
        this.url = url;
