...
public class BaseImageConfig extends BaseModelConfig {
    ...
    /**
     * 当前模型支持的图片宽高比，例如 {@code 1:1}、{@code 16:9}、{@code 9:16}。
     * <p>列表内容采用供应商原始表示，供上层产品根据所选模型展示可选项。</p>
     */
    protected List<String> supportedAspectRatios;

    /**
     * 当前模型支持的画质档位，例如 {@code standard}、{@code hd}。
     * <p>列表内容采用供应商原始表示，供上层产品根据所选模型展示可选项。</p>
     */
    ...
    public void setSupportTextToImage(Boolean value) {
        supportTextToImage = value;
    }

    /**
     * @return 仅当明确声明支持文生图时返回 {@code true}
     */
    public boolean isSupportTextToImage() {
        return Boolean.TRUE.equals(supportTextToImage);
    }
    ...
    public void setSupportImageToImage(Boolean value) {
        supportImageToImage = value;
    }

    /**
     * @return 仅当明确声明支持图生图时返回 {@code true}
     */
    public boolean isSupportImageToImage() {
        return Boolean.TRUE.equals(supportImageToImage);
    }

    public Boolean getSupportImageEditing() {
        return supportImageEditing;
    }

    public void setSupportImageEditing(Boolean value) {
        supportImageEditing = value;
    }

    /**
     * @return 仅当明确声明支持图片编辑时返回 {@code true}
     */
    public boolean isSupportImageEditing() {
        return Boolean.TRUE.equals(supportImageEditing);
    }

    public Boolean getSupportMultipleInputImages() {
        return supportMultipleInputImages;
    }

    public void setSupportMultipleInputImages(Boolean value) {
        supportMultipleInputImages = value;
    }

    /**
     * @return 仅当明确声明支持多图输入时返回 {@code true}
     */
    public boolean isSupportMultipleInputImages() {
        return Boolean.TRUE.equals(supportMultipleInputImages);
    }

    public Boolean getSupportMultipleOutputImages() {
        return supportMultipleOutputImages;
    }

    public void setSupportMultipleOutputImages(Boolean value) {
        supportMultipleOutputImages = value;
    }

    /**
     * @return 仅当明确声明支持多图输出时返回 {@code true}
     */
    public boolean isSupportMultipleOutputImages() {
        return Boolean.TRUE.equals(supportMultipleOutputImages);
    }

    public Boolean getSupportMask() {
        return supportMask;
    }

    public void setSupportMask(Boolean value) {
        supportMask = value;
    }
    ...
    public boolean isSupportMask() {
        return Boolean.TRUE.equals(supportMask);
    }
    ...
    public void setSupportNegativePrompt(Boolean value) {
        supportNegativePrompt = value;
    }
    ...
    public boolean isSupportNegativePrompt() {
        return Boolean.TRUE.equals(supportNegativePrompt);
    }
    ...
    public void setSupportPromptExtend(Boolean value) {
        supportPromptExtend = value;
    }
    ...
    public boolean isSupportPromptExtend() {
        return Boolean.TRUE.equals(supportPromptExtend);
    }
    ...
    public void setSupportWatermark(Boolean value) {
        supportWatermark = value;
    }
    ...
    public boolean isSupportWatermark() {
        return Boolean.TRUE.equals(supportWatermark);
    }
    ...
    public void setSupportSeed(Boolean value) {
        supportSeed = value;
    }
    ...
    public boolean isSupportSeed() {
        return Boolean.TRUE.equals(supportSeed);
    }

    public Integer getMaxInputImages() {
        return maxInputImages;
    }

    public void setMaxInputImages(Integer maxInputImages) {
        this.maxInputImages = maxInputImages;
    }

    public Integer getMaxOutputImages() {
        return maxOutputImages;
    }

    public void setMaxOutputImages(Integer maxOutputImages) {
