...
export default withMermaid(defineConfig({
    ...
    themeConfig: {
        ...
        sidebar: {
            '/zh/agent/': [
                {
                    text: 'Agent 智能体', items: [
                        ...
                        {text: '完整 Demo 示例', link: '/zh/agent/demo'},
                        ...
                        {text: 'AgentEventListener', link: '/zh/agent/agent-event-listener'},
                        ...
                        {text: '工具执行控制', link: '/zh/agent/tool-execution'},
                        ...
                        {text: '后台任务 Worker', link: '/zh/agent/worker'},
            ...
            '/zh/util/': developerReferenceSidebar,
            '/zh/other/': developerReferenceSidebar,
            '/zh/intro/': startAndChatSidebar,
            '/zh/chat/': startAndChatSidebar,
