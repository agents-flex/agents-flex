...
[Skills](../skills/overview.md) 采用文件系统组织能力。`SKILL.md` 描述使用条件和流程，Skill 目录还可以包含脚本、参考资料与模板。框架按需向模型披露 Skill 内容，避免把所有说明一次塞入上下文。
...
- `DocumentExtractionService`：从 PDF、Word、Excel、PowerPoint、HTML、纯文本等内容中提取文本；
