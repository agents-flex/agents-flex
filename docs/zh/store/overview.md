...
| 多后端适配 | Redis、Milvus、Pgvector、MariaDB、Elasticsearch、OpenSearch、MongoDB Atlas、Chroma、Qdrant 和云服务 |
...
| --- | --- | --- |
| Collection | Redis 逻辑集合、Milvus、MongoDB Atlas、Chroma、Qdrant、Pgvector/MariaDB 表 | `collectionName` |
