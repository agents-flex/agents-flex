...
public final class AgentToolContext {
    ...
    public String getRootTurnId() { return rootTurnId; }
    ...
    /** @return 当前工具名称 */
    public String getToolName() { return tool.getName(); }

    /** @return 由 turnId 和 toolCallId 组成的默认业务幂等键 */
    public String getIdempotencyKey() { return turnId + ":" + toolCallId; }

    /** @return 当前时刻是否已收到协作式取消请求 */
    public boolean isCancellationRequested() { return cancellationRequested.getAsBoolean(); }
