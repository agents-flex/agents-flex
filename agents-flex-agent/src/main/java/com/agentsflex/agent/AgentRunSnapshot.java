...
public final class AgentRunSnapshot implements Serializable {
    ...
    public AgentTaskPlan getTaskPlan() { return taskPlan == null ? null : taskPlan.copy(); }
    /** @return 当前 Run 是否允许模型规划 */
    public boolean isPlanningEnabled() { return planningEnabled; }
    /** @return 当前 Run 的规划嵌套深度 */
    public int getPlanningDepth() { return planningDepth; }
    ...
    public static final class Builder {
        ...
        /** 设置唯一租约令牌。 */
        public Builder leaseId(String value) { this.leaseId = value; return this; }
        /** 设置租约到期时间。 */
        ...
        /** 设置与 Run 同版本保存的任务计划。 */
        public Builder taskPlan(AgentTaskPlan value) { this.taskPlan = value; return this; }
        /** 设置当前 Run 是否开放规划工具。 */
        public Builder planningEnabled(boolean value) { this.planningEnabled = value; return this; }
        /** 设置规划父子树深度。 */
        public Builder planningDepth(int value) { this.planningDepth = value; return this; }
        /** 设置协作式取消标记。 */
