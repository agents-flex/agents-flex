...
public class AliyunImageModelConfig extends BaseImageConfig {
    ...
    public String getAsyncRequestPath() {
        return asyncRequestPath;
    }
    ...
    public String getQwenSynthesisPath() {
        return qwenSynthesisPath;
    }
    ...
    public void setPollIntervalMillis(long value) {
