...
import com.agentsflex.data.jdbc.dialect.impl.*;
...
public interface IDialect {
     ...
     */
    void buildTableColumns(String schemaName, TableInfo table,  DatabaseMetaData dbMeta, Connection conn) throws SQLException;
